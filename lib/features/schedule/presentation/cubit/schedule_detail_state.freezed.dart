...
mixin _$ScheduleDetailState {
 ...
 ScheduleItem get item; RequestStatus get toggleJoinStatus; bool get isJoined; Failure? get failure;
...
@useResult
$Res call({
 ScheduleItem item, RequestStatus toggleJoinStatus, bool isJoined, Failure? failure
});
...
/// Create a copy of ScheduleDetailState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? item = null,Object? toggleJoinStatus = null,Object? isJoined = null,Object? failure = freezed,}) {
  return _then(_self.copyWith(
item: null == item ? _self.item : item // ignore: cast_nullable_to_non_nullable
as ScheduleItem,toggleJoinStatus: null == toggleJoinStatus ? _self.toggleJoinStatus : toggleJoinStatus // ignore: cast_nullable_to_non_nullable
as RequestStatus,isJoined: null == isJoined ? _self.isJoined : isJoined // ignore: cast_nullable_to_non_nullable
...
$ScheduleItemCopyWith<$Res> get item {
  ...
  return $ScheduleItemCopyWith<$Res>(_self.item, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ScheduleItem item,  RequestStatus toggleJoinStatus,  bool isJoined,  Failure? failure)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ScheduleDetailState() when $default != null:
return $default(_that.item,_that.toggleJoinStatus,_that.isJoined,_that.failure);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ScheduleItem item,  RequestStatus toggleJoinStatus,  bool isJoined,  Failure? failure)  $default,) {final _that = this;
switch (_that) {
case _ScheduleDetailState():
return $default(_that.item,_that.toggleJoinStatus,_that.isJoined,_that.failure);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ScheduleItem item,  RequestStatus toggleJoinStatus,  bool isJoined,  Failure? failure)?  $default,) {final _that = this;
switch (_that) {
case _ScheduleDetailState() when $default != null:
return $default(_that.item,_that.toggleJoinStatus,_that.isJoined,_that.failure);case _:
  return null;
...
class _ScheduleDetailState implements ScheduleDetailState {
  const _ScheduleDetailState({required this.item, this.toggleJoinStatus = RequestStatus.initial, this.isJoined = false, this.failure});
  

@override final  ScheduleItem item;
@override@JsonKey() final  RequestStatus toggleJoinStatus;
...
@override $ScheduleItemCopyWith<$Res> get item;
...
/// Create a copy of ScheduleDetailState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? item = null,Object? toggleJoinStatus = null,Object? isJoined = null,Object? failure = freezed,}) {
