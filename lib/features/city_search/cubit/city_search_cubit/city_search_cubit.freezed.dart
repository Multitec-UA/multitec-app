...
extension CitySearchStatePatterns on CitySearchState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_CitySearchState value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(CitySearchStatus status, List<City> cities,
            PaginationMeta meta, String query, String? message)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _CitySearchState() when $default != null:
        return $default(
            _that.status, _that.cities, _that.meta, _that.query, _that.message);
      case _:
        return orElse();
    }
  }
